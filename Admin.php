...
<body>
<div id="container">
<a href="https://www.wysiwygwebbuilder.com" target="_blank"><img src="images/builtwithwwb19.png" alt="WYSIWYG Web Builder" style="position:absolute;left:1140px;top:773px;margin: 0;border-width:0;z-index:250" width="88" height="31"></a>
...
<li role="menuitem" class="nav-item"><a class="nav-link" href="" target="_self" onclick="window.location.href='./InBusquedad.php';return false;"><i class="fa fa-search"></i>Busquedad</a>
</li>
</ul>
</div>

<div id="wb_Shape4" style="position:absolute;left:300px;top:120px;width:1230px;height:120px;z-index:4;">
<img src="images/img0091.png" id="Shape4" alt="" width="1230" height="120" style="width:1230px;height:120px;"></div>
<div id="wb_Shape1" style="position:absolute;left:0px;top:0px;width:300px;height:240px;z-index:5;">
<img src="images/img0092.png" id="Shape1" alt="" width="300" height="240" style="width:300px;height:240px;"></div>
<div id="wb_Shape2" style="position:absolute;left:300px;top:0px;width:1230px;height:120px;z-index:6;">
<img src="images/img0093.png" id="Shape2" alt="" width="1230" height="120" style="width:1230px;height:120px;"></div>
...
<iframe id="Admin1" name="loginadmin" style="position:absolute;left:120px;top:318px;width:1238px;height:193px;z-index:10;" src="loginadmin.php"></iframe>
</div>
</body>
</html>