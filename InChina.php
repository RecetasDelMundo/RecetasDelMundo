...
<link href="InChina.css" rel="stylesheet">
</head>
<body>
<div id="container">
...
<li role="menuitem" class="nav-item firstmain"><a class="nav-link" href="./InSur.php" target="_self" onclick="window.location.href='./InAsia.php';return false;"><i class="fa fa-arrow-circle-left"></i></a>
</li>
</ul>
</div>
<div id="wb_Shape4" style="position:absolute;left:300px;top:120px;width:1230px;height:120px;z-index:4;">
<img src="images/img0156.png" id="Shape4" alt="" width="1230" height="120" style="width:1230px;height:120px;"></div>
<div id="wb_Shape1" style="position:absolute;left:0px;top:0px;width:300px;height:240px;z-index:5;">
<img src="images/img0157.png" id="Shape1" alt="" width="300" height="240" style="width:300px;height:240px;"></div>
<div id="wb_Shape2" style="position:absolute;left:300px;top:0px;width:1230px;height:120px;z-index:6;">
<img src="images/img0158.png" id="Shape2" alt="" width="1230" height="120" style="width:1230px;height:120px;"></div>
