...
<link href="InEuropa.css" rel="stylesheet">
</head>
<body>
<div id="container">
...
<a href="#" onclick="window.location.href='./InAlemania.php';return false;"><img src="images/Alemania.png" id="Image2" alt="" width="275" height="165"></a></div>
<div id="wb_Image3" style="position:absolute;left:626px;top:440px;width:275px;height:145px;z-index:5;">
<a href="#" onclick="window.location.href='./InEspana.php';return false;"><img src="images/Espana.png" id="Image3" alt="" width="275" height="183"></a></div>
<div id="wb_Image4" style="position:absolute;left:1018px;top:440px;width:275px;height:145px;z-index:6;">
<a href="#" onclick="window.location.href='./InFrancia.php';return false;"><img src="images/Francia.png" id="Image4" alt="" width="275" height="184"></a></div>
<div id="wb_Image5" style="position:absolute;left:462px;top:702px;width:275px;height:145px;z-index:7;">
<a href="#" onclick="window.location.href='./InItalia.php';return false;"><img src="images/Italia.png" id="Image5" alt="" width="275" height="184"></a></div>
<div id="wb_Heading4" style="position:absolute;left:299px;top:621px;width:156px;height:48px;z-index:8;">
<h1 id="Heading4">Alemania</h1></div>
<div id="wb_Heading5" style="position:absolute;left:685px;top:621px;width:156px;height:48px;z-index:9;">
<h1 id="Heading5">España</h1></div>
<div id="wb_Heading6" style="position:absolute;left:1077px;top:621px;width:156px;height:48px;z-index:10;">
<h1 id="Heading6">Francia</h1></div>
<div id="wb_Image6" style="position:absolute;left:820px;top:702px;width:275px;height:145px;z-index:11;">
<a href="#" onclick="window.location.href='./InReino.php';return false;"><img src="images/Reino_Unido.png" id="Image6" alt="" width="275" height="138"></a></div>
<div id="wb_Heading7" style="position:absolute;left:521px;top:874px;width:156px;height:48px;z-index:12;">
<h1 id="Heading7">Italia</h1></div>
<div id="wb_Heading8" style="position:absolute;left:879px;top:874px;width:156px;height:72px;z-index:13;">
<h1 id="Heading8">Reino Unido</h1></div>
<div id="wb_CssMenu3" style="position:absolute;left:0px;top:240px;width:1536px;height:33px;z-index:14;">
...
<img src="images/img0029.png" id="Shape1" alt="" width="300" height="240" style="width:300px;height:240px;"></div>
<div id="wb_Shape2" style="position:absolute;left:300px;top:0px;width:1230px;height:240px;z-index:17;">
<img src="images/img0030.png" id="Shape2" alt="" width="1230" height="240" style="width:1230px;height:240px;"></div>
...
<img src="images/img0070.png" id="Shape4" alt="" width="1230" height="120" style="width:1230px;height:120px;"></div>
<div id="wb_Shape3" style="position:absolute;left:0px;top:0px;width:300px;height:240px;z-index:22;">
<img src="images/img0071.png" id="Shape3" alt="" width="300" height="240" style="width:300px;height:240px;"></div>
<div id="wb_Shape5" style="position:absolute;left:300px;top:0px;width:1230px;height:120px;z-index:23;">
<img src="images/img0072.png" id="Shape5" alt="" width="1230" height="120" style="width:1230px;height:120px;"></div>
