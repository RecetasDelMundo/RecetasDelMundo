...
<link href="InEgipto.css" rel="stylesheet">
</head>
<body>
<div id="container">
...
<li role="menuitem" class="nav-item firstmain"><a class="nav-link" href="./InAfrica.php" target="_self" onclick="window.location.href='./InAfrica.php';return false;"><i class="fa fa-arrow-circle-left"></i></a>
</li>
</ul>
</div>
<div id="wb_Shape4" style="position:absolute;left:300px;top:120px;width:1230px;height:120px;z-index:4;">
<img src="images/img0049.png" id="Shape4" alt="" width="1230" height="120" style="width:1230px;height:120px;"></div>
<div id="wb_Shape1" style="position:absolute;left:0px;top:0px;width:300px;height:240px;z-index:5;">
<img src="images/img0050.png" id="Shape1" alt="" width="300" height="240" style="width:300px;height:240px;"></div>
<div id="wb_Shape2" style="position:absolute;left:300px;top:0px;width:1230px;height:120px;z-index:6;">
<img src="images/img0062.png" id="Shape2" alt="" width="1230" height="120" style="width:1230px;height:120px;"></div>
