...
<link href="InAsia.css" rel="stylesheet">
</head>
<body>
<div id="container">
...
<a href="#" onclick="window.location.href='./InChina.php';return false;"><img src="images/China.png" id="Image2" alt="" width="275" height="184"></a></div>
<div id="wb_Image3" style="position:absolute;left:626px;top:440px;width:275px;height:145px;z-index:5;">
<a href="#" onclick="window.location.href='./InIndia.php';return false;"><img src="images/India.png" id="Image3" alt="" width="275" height="184"></a></div>
<div id="wb_Image4" style="position:absolute;left:1018px;top:440px;width:275px;height:145px;z-index:6;">
<a href="#" onclick="window.location.href='./InJapon.php';return false;"><img src="images/Japon.png" id="Image4" alt="" width="275" height="184"></a></div>
<div id="wb_Image5" style="position:absolute;left:462px;top:702px;width:275px;height:145px;z-index:7;">
<a href="#" onclick="window.location.href='./InRussia.php';return false;"><img src="images/Russia.png" id="Image5" alt="" width="275" height="184"></a></div>
...
<a href="#" onclick="window.location.href='./InThailandia.php';return false;"><img src="images/Thailandia.png" id="Image6" alt="" width="275" height="184"></a></div>
...
<img src="images/img0035.png" id="Shape1" alt="" width="300" height="240" style="width:300px;height:240px;"></div>
<div id="wb_Shape2" style="position:absolute;left:300px;top:0px;width:1230px;height:240px;z-index:17;">
<img src="images/img0036.png" id="Shape2" alt="" width="1230" height="240" style="width:1230px;height:240px;"></div>
...
<img src="images/img0079.png" id="Shape4" alt="" width="1230" height="120" style="width:1230px;height:120px;"></div>
<div id="wb_Shape3" style="position:absolute;left:0px;top:0px;width:300px;height:240px;z-index:22;">
<img src="images/img0080.png" id="Shape3" alt="" width="300" height="240" style="width:300px;height:240px;"></div>
<div id="wb_Shape5" style="position:absolute;left:300px;top:0px;width:1230px;height:120px;z-index:23;">
<img src="images/img0081.png" id="Shape5" alt="" width="1230" height="120" style="width:1230px;height:120px;"></div>
